...
# def thread_baidu_upload(threadname,bp,downfilepath_queue):
#     print('[√]百度云上传服务已启动 %s\n'%threadname)
#     while(True):
#         if downfilepath_queue.empty() == True:
#             time.sleep(2)
#         else:
#             downfilepath = downfilepath_queue.get()
#             bp.cleanup()
#             bp.upload(localpath=downfilepath, remotepath='bilicake_videos', ondup='newcopy')
# =============================================================================
# 主函数（登录,代理,Cookies）
# =============================================================================
...
# baidu_upload_thread.start()BV1KB4y1a7ZC
...
#         print('[-] 程序终止 UnixTime:%d'%int(time.time()))
#         break
